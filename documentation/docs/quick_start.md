...
=== "Ubuntu 24.04"
    ...
    Debian package [available here](https://package.cosmian.com/findex-server/0.4.14/ubuntu-24.04/).
...
=== "RHEL 9"
    ...
    An other option include running the server binary directly installing the
    Debian package [available here](https://package.cosmian.com/findex-server/0.4.14/rhel9/).
