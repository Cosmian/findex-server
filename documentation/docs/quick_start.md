...
=== "Ubuntu 24.04"
    ...
    Debian package [available here](https://package.cosmian.com/findex-server/0.4.4/ubuntu-24.04/).
    ...
    wget https://package.cosmian.com/findex-server/0.4.4/ubuntu-24.04/cosmian-findex-server_0.4.4-1_amd64.deb
    sudo apt install ./cosmian-findex-server_0.4.4-1_amd64.deb
...
=== "RHEL 9"
    ...
    An other option include running the server binary directly installing the
    Debian package [available here](https://package.cosmian.com/findex-server/0.4.4/rhel9/).
    ...
    wget https://package.cosmian.com/findex-server/0.4.4/rhel9/cosmian_findex_server-0.4.4-1.x86_64.rpm
    sudo dnf install ./cosmian_findex_server-0.4.4-1.x86_64.rpm
    cosmian_findex_server --version
    ```
...
=== "MacOS"
    ...
    ```console title="On local machine"
    wget https://package.cosmian.com/findex-server/0.4.4/macos_arm-release.zip
...
=== "Windows"
    ...
    ```console title="Build archive"
     https://package.cosmian.com/findex-server/0.4.4/windows-release.zip
    ```
